...
<head>
    ...
    <title>Login — Surat Jalan BAUER</title>
    ...
    <style>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        body {
            ...
            background: linear-gradient(145deg, #0f172a 0%, #1e3a8a 45%, #1e40af 75%, #0284c7 100%);
            padding: 2rem;
            position: relative;
            overflow: hidden;
        }
        ...
        .login-panel-left {
            flex: 1;
            background: linear-gradient(160deg, #1e40af, #0ea5e9);
            padding: 3rem 2.5rem;
            display: flex;
    ...
    <div class="login-wrap">
        ...
        <div class="login-panel-left">
            <div class="brand">
                ...
                <div>
                    <div class="brand-name">BPI Store</div>
                    <div class="brand-sub">International Foundation Specialist</div>
                </div>
            </div>
            ...
            <div class="stat-items">
                <div class="stat-item">
                    ...
                    <div class="stat-label">Buat & kelola Surat Jalan otomatis</div>
                </div>
                <div class="stat-item">
                    <div class="stat-icon"><i class="bi bi-folder2-open"></i></div>
                    <div class="stat-label">Organisasi berdasarkan Project</div>
                </div>
                <div class="stat-item">
